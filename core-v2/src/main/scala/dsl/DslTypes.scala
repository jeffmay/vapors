...
trait DslTypes extends Any {
  ...
  /**
   * The effect type or [[shapeless3.deriving.Id]].
   */
  type F[+_]

  /**
   * The type of wrapper (for example [[justification.Justified]] or [[shapeless3.deriving.Id]]).
   *
   ...
   */
  final type ExprFunction[I, +O] = (I ~:> I) => (I ~:> O)
