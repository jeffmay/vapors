...
// TODO: Figure out how to pass evidence per value in a nested tagged structure.
//       Maybe we can replace this data type all together?
//       I think we need something like Fix and Cofree, but named more appropriately.
