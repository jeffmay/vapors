...
class SimpleJustifiedSubtractionSpec extends FunSuite {
  ...
  test("Int - Int") {
    ...
    assertEquals(
      observed,
      Justified.byInference("subtract", 1, NonEmptyList.of(Justified.byConst(2), Justified.byConst(1))),
    )
  }
  ...
  test("Long (max) - Int (max)") {
    ...
    assertEquals(
      ...
      Justified.byInference(
        "subtract",
        expected,
        NonEmptyList.of(Justified.byConst(Long.MaxValue), Justified.byConst(Int.MaxValue)),
      ),
    )
  }
  ...
  test("Int (max) - Long (max)") {
    ...
    assertEquals(
      ...
      Justified.byInference(
        "subtract",
        expected,
        NonEmptyList.of(Justified.byConst(Int.MaxValue), Justified.byConst(Long.MaxValue)),
      ),
    )
  }
  ...
  test("Double (max) - Int (max)") {
    ...
    assertEquals(
      ...
      Justified.byInference(
        "subtract",
        expected,
        NonEmptyList.of(Justified.byConst(Double.MaxValue), Justified.byConst(Int.MaxValue)),
      ),
    )
  }
  ...
  test("Int (max) - Double (max)") {
    ...
    assertEquals(
      ...
      Justified.byInference(
        "subtract",
        expected,
        NonEmptyList.of(Justified.byConst(Int.MaxValue), Justified.byConst(Double.MaxValue)),
      ),
    )
  }
  ...
  test("Float (max) - Int (max)") {
    ...
    assertEquals(
      ...
      Justified.byInference(
        "subtract",
        expected,
        NonEmptyList.of(Justified.byConst(Float.MaxValue), Justified.byConst(Int.MaxValue)),
      ),
    )
  }
  ...
  test("Int (max) - Float (max)") {
    ...
    assertEquals(
      ...
      Justified.byInference(
        "subtract",
        expected,
        NonEmptyList.of(Justified.byConst(Int.MaxValue), Justified.byConst(Float.MaxValue)),
      ),
    )
  }
  ...
  test("Double (max) - Float (max)") {
    ...
    assertEquals(
      ...
      Justified.byInference(
        "subtract",
        expected,
        NonEmptyList.of(Justified.byConst(Double.MaxValue), Justified.byConst(Float.MaxValue)),
      ),
    )
  }
  ...
  test("Float (max) - Double (max)") {
    ...
    assertEquals(
      ...
      Justified.byInference(
        "subtract",
        expected,
        NonEmptyList.of(Justified.byConst(Float.MaxValue), Justified.byConst(Double.MaxValue)),
      ),
    )
  }
  ...
  test("Instant - Duration") {
    ...
    assertEquals(
      observed,
      Justified.byInference("subtract", expected, NonEmptyList.of(Justified.byConst(now), Justified.byConst(duration))),
    )
  }
  ...
  test("LocalDate - Period") {
    ...
    assertEquals(
      observed,
      Justified.byInference("subtract", expected, NonEmptyList.of(Justified.byConst(today), Justified.byConst(period))),
    )
  }
      ...
      Justified.byInference(
        ...
        NonEmptyList.of(
          Justified.byInference(
            "subtract",
            today.minus(period),
            NonEmptyList.of(Justified.byConst(today), Justified.byConst(period)),
          ),
