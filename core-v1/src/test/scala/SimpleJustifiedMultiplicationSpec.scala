...
class SimpleJustifiedMultiplicationSpec extends munit.FunSuite {
  ...
  test("Justified[Int] * Justified[Int]") {
    ...
    val expected = Justified.byInference("multiply", 4, NonEmptyList.of(Justified.byConst(2), Justified.byConst(2)))
  ...
  test("Justified[Int] * Justified[Int] * Justified[Int]") {
    ...
    val expected = Justified.byInference(
      ...
      8,
      NonEmptyList.of(
        Justified.byInference("multiply", 4, NonEmptyList.of(Justified.byConst(2), Justified.byConst(2))),
        Justified.byConst(2),
      ),
    )
    assertEquals(observed, expected)
  ...
  test("Justified[Long] + Justified[Int]") {
    ...
    val observed = expr.run()
    val expected = Justified.byInference("multiply", 4L, NonEmptyList.of(Justified.byConst(2L), Justified.byConst(2)))
    assertEquals(observed, expected)
  }
  ...
  test("Justified[Int] + Justified[Long]") {
    ...
    val observed = expr.run()
    val expected = Justified.byInference("multiply", 4L, NonEmptyList.of(Justified.byConst(2), Justified.byConst(2L)))
    assertEquals(observed, expected)
  }
  ...
  test("Justified[Int] * Justified[Double]") {
    ...
    assertEquals(
      observed,
      Justified.byInference("multiply", 1d, NonEmptyList.of(Justified.byConst(2), Justified.byConst(0.5d))),
    )
  }
  ...
  test("Justified[Double] * Justified[Int]") {
    ...
    assertEquals(
      observed,
      Justified.byInference("multiply", 1d, NonEmptyList.of(Justified.byConst(0.5d), Justified.byConst(2))),
    )
  }
  ...
  test("Justified[Int] * Justified[Float]") {
    ...
    assertEquals(
      observed,
      Justified.byInference("multiply", 1f, NonEmptyList.of(Justified.byConst(2), Justified.byConst(0.5f))),
    )
  }
  ...
  test("Justified[Double] * Justified[Float]") {
    ...
    assertEquals(
      observed,
      Justified.byInference("multiply", 1d, NonEmptyList.of(Justified.byConst(0.5d), Justified.byConst(2f))),
    )
  }
  ...
  test("Justified[Float] * Justified[Double]") {
    ...
    assertEquals(
      observed,
      Justified.byInference("multiply", 1d, NonEmptyList.of(Justified.byConst(2f), Justified.byConst(0.5d))),
    )
  }
  ...
  test("Justified[Float] * Justified[Int]") {
    ...
    assertEquals(
      observed,
      Justified.byInference("multiply", 1f, NonEmptyList.of(Justified.byConst(0.5f), Justified.byConst(2))),
    )
  }
  ...
  test("Justified[String] * Justified[Int]") {
    ...
    val expected = Justified.byInference(
      "multiply",
      "*" * 4,
      NonEmptyList.of(Justified.byConst("*"), Justified.byConst(4)),
    )
    assertEquals(observed, expected)
  }
    ...
    val expected = Justified.byInference(
      ...
      NonEmptyList.of(
        Justified.byInference(
          "multiply",
          "*" * 2,
          NonEmptyList.of(Justified.byConst("*"), Justified.byConst(2)),
        ),
        Justified.byConst(2),
      ),
    )
