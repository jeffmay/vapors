...
class SimpleJustifiedAdditionSpec extends munit.FunSuite {
  ...
  test("Justified[Int] + Justified[Int] + Justified[Int]") {
    ...
    val expected = Justified.byInference(
      ...
      6,
      NonEmptyList.of(
        Justified.byInference("add", 3, NonEmptyList.of(Justified.byConst(1), Justified.byConst(2))),
        Justified.byConst(3),
      ),
    )
    assertEquals(observed, expected)
  ...
  test("Double (min) + Int (max)") {
    ...
    assertEquals(
      ...
      Justified.byInference(
        "add",
        expected,
        NonEmptyList.of(Justified.byConst(Double.MinValue), Justified.byConst(Int.MaxValue)),
      ),
    )
  }
  ...
  test("Int (max) + Double (min)") {
    ...
    assertEquals(
      ...
      Justified.byInference(
        "add",
        expected,
        NonEmptyList.of(Justified.byConst(Int.MaxValue), Justified.byConst(Double.MinValue)),
      ),
    )
  }
  ...
  test("Float (max) + Int (min)") {
    ...
    assertEquals(
      ...
      Justified.byInference(
        "add",
        expected,
        NonEmptyList.of(Justified.byConst(Float.MaxValue), Justified.byConst(Int.MinValue)),
      ),
    )
  }
  ...
  test("Int (max) + Float (min)") {
    ...
    assertEquals(
      ...
      Justified.byInference(
        "add",
        expected,
        NonEmptyList.of(Justified.byConst(Int.MaxValue), Justified.byConst(Float.MinValue)),
      ),
    )
  }
  ...
  test("Double (max) + Float (min)") {
    ...
    assertEquals(
      ...
      Justified.byInference(
        "add",
        expected,
        NonEmptyList.of(Justified.byConst(Double.MaxValue), Justified.byConst(Float.MinValue)),
      ),
    )
  }
  ...
  test("Float (min) + Double (max)") {
    ...
    assertEquals(
      ...
      Justified.byInference(
        "add",
        expected,
        NonEmptyList.of(Justified.byConst(Float.MaxValue), Justified.byConst(Double.MinValue)),
      ),
    )
  }
  ...
  test("Justified[LocalDate] + Justified[Period] + Justified[Period]") {
    ...
    val expected = Justified.byInference(
      ...
      NonEmptyList.of(
        Justified
          .byInference("add", today.plus(period), NonEmptyList.of(Justified.byConst(today), Justified.byConst(period))),
